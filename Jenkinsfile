...
pipeline {
    ...
    parameters {
        string(
            name: "Branch_Name", 
            defaultValue: 'master', 
            description: 'A name of the Git branch that contain the jenkinfile code')    
        string(
            name: "Image_Name", 
            defaultValue: 'manage_contact_app', 
            description: 'A name of the image that you want to build')    
        ...
        string(
            name: 'HTTP_PROXY', 
            defaultValue: '', 
            description: 'The proxy address to be used to connect to outside network when running docker build.')
